...
import {
  ...
  getThongTinUserThunk,
  uploadAnhThunk,
} from "store/CapNhatThongTin/thunk";
...
const Account = () => {
  ...
  const handelAvatar = () => {
    return ThongTinUser?.avatar ? (
      <img
        src={avatar ? avatar : ThongTinUser?.avatar}
        className="w-[150px] shadow border block object-cover h-[150px] max-ipad:w-[150px] max-ipad:h-[150px] max-tablet:w-[100px] max-tablet:h-[100px]  rounded-[100%]"
      />
    ) : (
      <UserIcon className="!w-16 !h-16" />
    );
  };
  // xử lý data cho handelSubmit
          ...
          <section>
            ...
            <section className="my-7 space-y-5">
              <div className="flex  space-y-5 justify-between">
                ...
                <p className="edit" onClick={() => setEditEmail(!editEmail)}>
            ...
            <section className="my-7 space-y-5">
              <div className="flex  space-y-5 justify-between">
                <div className="space-y-3">
                  ...
                  <p className="name">
                    {editPhone
                      ? "Sử dụng số điện thoại mà Airbnb có thể liên lạc với bạn ."
                      : `${ThongTinUser?.phone}`}
                  </p>
                </div>
                <p className="edit" onClick={() => setEditPhone(!editPhone)}>
              ...
              <div className="flex  space-y-5 justify-between">
                <div className="space-y-3">
                  ...
                  <p className="name">
                    {editBirth
                      ? "Thông tin ngày sinh"
                      : `${ThongTinUser?.birthday}`}
                  </p>
                </div>
                <p className="edit" onClick={() => setEditBirth(!editBirth)}>
                  {editBirth ? "Hủy" : "Chỉnh sửa"}
                </p>
              </div>
              {editBirth && (
                <DatePicker
                  ...
                  placeholder={ThongTinUser?.birthday}
            ...
            <section className="my-7 space-y-5">
              <div className="flex  space-y-5 justify-between">
                ...
                <p className="edit" onClick={() => setEditGender(!editGender)}>
...
const AccountCSS = styled.div`
  ...
  .avatar-user {
    padding: 40px;
    border: 1px solid rgba(158, 156, 155, 0.4);
    border-radius: 20px;
  }
  p {
    font-size: 18px;
