...
import { MenuOutlined, StarOutlined, UserOutlined } from "@ant-design/icons";
...
export const HeaderDetailPage = () => {
  ...
  return (
    <>
      <div className="shadow-md border-[1px] p-2 sticky top-0 bg-white z-10 ">
        <div className="flex py-[3px] font-semibold items-center m-auto justify-between max-w-[90%]">
          {/* home */}
          <section>
          ...
          <section>
            <div
              className={`flex py-3 ${
                scrolling ? "hidden zoom-out" : "zoom-in"
              }`}
            >
              <div className="relative max-tablet:hidden">
                ...
                <button
                  onClick={() => {
                    dispatch(findRoomThunk(idLocaiton));
          ...
          <section>
            <div
              className={`flex ${scrolling ? "hidden zoom-out" : "  zoom-in"}`}
            >
          ...
          <section>
            <div
              className={`flex ${scrolling ? "zoom-in" : "hidden zoom-out"}`}
            >
              <div className="relative flex my-[14px] justify-between">
                <div className="flex ">
                  <div className="text-xs mr-5">
                    ...
                    <div className="flex text-gray-600 font-semibold text-[16px]">
                      <StarOutlined className="" />
                      <p className="text-black  font-lg">$4.85</p>
                      <p className="font-light text-xs items-center flex ml-2 ">
                        151 reviews
                      </p>
                    </div>
                  </div>
                  {/* <button className="bg-mainColor px-5 py-3 rounded-lg text-white">
                    Reserve
                  </button> */}
                </div>
              </div>
