...
import { findRoomThunk } from "store/FindRoom/thunk";
...
const HeaderListRoom = () => {
  ...
  const items: MenuProps["items"] = [
    {
      ...
      label: (
        <NavLink
          to={""}
          className="font-500 text-[15px] flex items-center space-x-4"
        >
          <svg
    ...
    },
    {
      ...
      label: (
        <NavLink
          to={PATH.account}
          className="font-500 text-[15px] flex items-center"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
    ...
    },
    {
      ...
      label: (
        ...
        >
          ...
          <span className="ml-[5px]">Admin</span>
        </NavLink>
      ),
    },
    {
    ...
    },
    {
      ...
      label: (
        <p
          ...
          className="text-[15px] font-500 flex items-center space-x-4"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
          ...
          {token ? (
            ...
            <span className="ml-[5px]" onClick={() => navigate(PATH.Login)}>
              {" "}
              Login
            </span>
          )}
  ...
  const [idLocaiton, setIdLocation] = useState<number>();
  useEffect(() => {
  ...
  return (
    <HeaderCSS>
      <div className=" border-[1px] p-2 sticky top-0 bg-white z-10  ">
        <div className="flex py-[20px] h-[104px] font-semibold items-center m-auto justify-between max-w-[90%] ">
          {/* home */}
          <div className="max-tablet:hidden max-ipad:mr-[10px]">
            <Link to={`/`}>
              <svg
                width="102"
          ...
          <section>
            <div className={`flex items-center`}>
              <div className="relative ">
                <Select
                  className="max-ipad:w-[300px] w-[500px]  max-tablet:w-[180px]"
                  id="select"
                  showSearch
                ...
                <button
                  className=" "
                  onClick={() => {
                    dispatch(findRoomThunk(idLocaiton ? idLocaiton : 0));
                    navigate(`/ListRoom/${idLocaiton}`);
                  }}
                >
                  <img
                    className="h-[30px] absolute right-3 top-1/2 transform -translate-y-1/2 bg-mainColor p-[5px] rounded-3xl  "
                    src="https://i.ibb.co/WVvJrx1/search.png"
                    alt="../"
                  />
                </button>
              </div>
          ...
          <section>
            <div className="flex">
              <p className="ml-14 hidden font-500 text-[20px]">
                Switch to hosting
              </p>
              <div className="ml-14 hidden lg:block">
                <img
                  className="w-[25px]"
                  src="https://i.ibb.co/8KfHTFt/translation.png"
                  alt=""
                />
              </div>
              <div className="lg:ml-[14px]">
                ...
                <Dropdown menu={{ items }}>
                  <a
                    className="border-2 cursor-pointer border-gray-300 px-[15px] py-[10px] rounded-3xl "
        ...
        <section>
          <div
            className={`flex py-5 border-t-2 items-center sticky top-0 z-11 ${
              scrolling ? "zoom-in" : "hidden zoom-out"
            }`}
          >
            <img
              className="w-16 max-ip678Plus:w-[30px] mx-auto cursor-pointer"
              src={
